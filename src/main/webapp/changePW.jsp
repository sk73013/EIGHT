...
<body>
    ...
    <div class="row" style="padding-top:20px">
        <div class="col-xs-12"><h1>Change Password</h1></div>
    </div>
    <form method="post" action="loginAct.jsp">
    <div class="row" style="padding-top:20px">
        <div class="col-md-5">
        	<div class="form-group">
				<input type="password" class="form-control" placeholder="Current Password" name="user_PW" maxlength="20"/>
			</div>
        </div>
    </div>
    <div class="row" style="padding-top:20px">
        <div class="col-md-5" >
        	<div class="form-group">
				<input type="password" class="form-control" placeholder="New Password" name="user_NewPW" maxlength="20"/>
			</div>
        </div>
    </div>
     <div class="row" style="padding-top:20px">
     	<div class="col-md-3" style="padding-left:70px">
        	<input type="button" class="btn btn-primary form=control" value="Change" style="width:130px; height:40px;" onclick="location='AccountManageP.jsp'"/>
        </div>
        <div class="col-md-4">
