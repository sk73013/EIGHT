        ...
        <div class="col-md-4">
	        <form method="post" action="loginAct.jsp">
				...
				<div class="row" style="padding-top:20px">
	        		...
	        		<div class="col-md-3">	
						<input type="submit" class="btn btn-primary form=control" value="Login" style="width:95px; height:40px;"/> 
					</div>
				</div>
				...
				<div class="row" style="padding-top:20px">
	        		...
	        		<div class="col-md-3">
						<input type="button" class="btn btn-primary form=control" value="Sign UP" style="width:100px; height:40px;" onclick="location='SignUp.jsp'"/>
					</div>
				</div>
